...
// Create Shape
var outerBoxGeometry = new THREE.BoxGeometry( 4, 4, 4 );
...
cubeouter.position.x = 0.5;
cubeouter.position.y = 0.5;
cubeouter.position.z = 0.5;
scene.add( cubeouter );
...
function Keyboard() {
    ...
    if ( cube.position.x > 2 || cube.position.y > 2 || cube.position.z > 2 || cube.position.x < -1 || cube.position.y < -1 || cube.position.z < -1 ){
